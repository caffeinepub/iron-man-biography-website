...
export interface BiographySection { 'title' : string, 'content' : string }
...
export interface _SERVICE {
  ...
  'addGalleryImage' : ActorMethod<
    ...
    undefined
  >,
  'getBiographySections' : ActorMethod<[], Array<BiographySection>>,
  'getGalleryImages' : ActorMethod<[], Array<GalleryImage>>,
  'updateBiographySection' : ActorMethod<[string, string], undefined>,
}
