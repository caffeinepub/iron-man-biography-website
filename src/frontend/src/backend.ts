...
export class Backend implements backendInterface {
    ...
    async addGalleryImage(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBiographySections(): Promise<Array<BiographySection>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBiographySections();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateBiographySection(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBiographySection(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
